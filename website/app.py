...
if df is not None:
    ...
    st.error(
        "Failed to load weather data. Please try a different location or time period."
    )
    st.markdown("""
    ### Possible reasons for data retrieval failure:
    - API service might be temporarily unavailable
    - The selected time period may not have data available
    - Network connectivity issues

    Please try again later or select different parameters.
    """)
